---
title: Pricing
description: AI Tutor Agents Pricing
---

How much does AI Tutor Agents cost? AI Tutor Agents offer many pricing plan but you can start using it for free. You can easily build a usable chatbot for free but you'll have to upgrade to a higher plan if you want customizations.
...
Branding customization: This feature allow you to remove the "Powered by AI Tutor Agents"
...
### Enterprise Plan
The ENTERPRISE plan is designed for big business. It includes any feature from all other plans and custom price based on your requirements. Contact the team at AI Tutor Agents@gmail.com and we will send you your custom price.