...
Welcome to [AI Tutor Agents](https://www.openassistantgpt.io/), in this guide we will guide you on how to build a smart chatbot for you website.
...
- A Google or Github account to connect to [OpenAssistantGPT](https://https://open-assistant-gpt.vercel.app/).
- An [OpenAI](https://openai.com/) account, with you credit card configured on it.

Small note! If you prefer interactive in-app onboarding you can start with this https://open-assistant-gpt.vercel.app/dashboard/onboarding.
